...
const InvoicePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 shadow-lg mt-10 rounded-2xl"
         style={{ backgroundColor: 'rgb(152, 161, 188)', color: 'rgb(8, 12, 59)' }}>
      {/* Download Button */}
      ...
      <div ref={targetRef}>
        ...
        <div className="mt-6">
          <table className="w-full table-auto border-collapse">
            <thead>
              <tr style={{ backgroundColor: 'rgb(222, 211, 196)', color: 'rgb(8, 12, 59)' }}>
            ...
            <tbody>
              {purchasedItems.map((item, idx) => (
                <tr key={idx} className="border-t" style={{ backgroundColor: idx % 2 === 0 ? 'white' : 'rgb(244, 235, 211)' }}>
