...
const Footer = () => {
    return (
       <footer className="mt-30 flex lg:flex-row flex-col justify-between footer sm:footer-horizontal bg-gradient-to-tr from-[#555879] to-[#98A1BC] text-base-content p-10 overflow-x-hidden">
